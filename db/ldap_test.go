	...
	newLdapConfiguration = []types.LdapConfiguration{
		{
			...
			ServiceAccountDN:       "CN=Service Account,CN=Users,DC=auth,DC=example,DC=com",
		...
		},
		{
			...
			Port:                   46,
			BaseDN:                 "DC=auth,DC=example,DC=com",
			ServiceAccountDN:       "CN=xxx,CN=Users,DC=auth,DC=example,DC=com",
		...
		},
		{
			...
			Port:                   4556,
			BaseDN:                 "DC=auth,DC=example,DC=com",
			ServiceAccountDN:       "CN=yyy,CN=Users,DC=auth,DC=example,DC=com",
